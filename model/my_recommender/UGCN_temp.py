...
class UGCN1(AbstractRecommender):
    ...
    def _create_variable(self):
        ...
        self.weights['user_embedding'] = Embedding(self.n_users, output_dim=self.emb_dim,
                                                   embeddings_initializer=initializer,
                                                   name="user_embedding")
        self.weights['item_embedding'] = Embedding(self.n_items, output_dim=self.emb_dim,
